...
class Patcher:
    def __init__(self, path_to_save: str, base_path: str) -> None:
    ...
    def patch_sampler(self, img: np.ndarray, fname: str, patch_width: int = 640, patch_height: int = 640,) -> None:
        ...
        print('printing basepath.................', self.base_path)

        label_path = os.path.join(self.base_path, f"{fname}.txt")
...
def main():
    base_path = "/home/ikenna/anaconda3/envs/env_new/yolov7/Object Detection2_Aug/yolo_class_drop_withaug2"
    path_to_save = "/home/ikenna/anaconda3/envs/env_new/yolov7/Object Detection2_Aug/patch_data_aug2"

    for split in ["patched_data"]:

        patcher = Patcher(os.path.join(path_to_save, split), base_path)
