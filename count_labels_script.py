...
def count_bounding_boxes(directory_path):
    ...
    with open('/home/ikenna/anaconda3/envs/env_new/yolov7/FULL_SPLITING_IMG/Focussymbol.txt', 'r') as classes_file:
...
directory_path = '/home/ikenna/anaconda3/envs/env_new/yolov7/FULL_SPLITING_IMG/testingsplit/valid/labels'
